...
const generateInterviewQuestions = async (job: JobDetails): Promise<string[]> => {
  if (USE_AI) {
    try {
      const prompt = `
...
const generateRuleBasedQuestions = (job: JobDetails): string[] => {
...
const generatePreparationTips = (job: JobDetails): string[] => {
  const tips: string[] = [];
...
const generateTopics = (job: JobDetails): string[] => {
  const topics: string[] = [];
...
export const generateInterviewPreparation = async (data: InterviewPrepData) => {
...
export const getInterviewPreparation = async (jobId: string, userId: string) => {
...
export const getUserInterviewPreparations = async (userId: string) => {
...
export const deleteInterviewPreparation = async (jobId: string, userId: string) => {
